class Bitmap
	...
	def borderskin
		...
		# CORNERS
	    blt(0,0,src,Rect.new(0,0,w,h),o) # top left
	    blt(width-w,0,src,Rect.new(96,0,w,h),o) # top right

	    blt(0,height-h,src,Rect.new(0,96,w,h),o) # bottom left
	    blt(width-w,height-h,src,Rect.new(96,96,w,h),o) # bottom right
	    
	   # left side
	   stretch_blt(Rect.new(0,h,w,height-64),src,Rect.new(0,h+16,w,h),o)

	   # Right
	   stretch_blt(Rect.new(width-w,h,w,height-64),src,Rect.new(96,h,w,h),o)

	   # top
	   stretch_blt(Rect.new(w,0,width-64,32),src,Rect.new(32,0,64,32),o)

	   # bottom
	   stretch_blt(Rect.new(w,height-h,width-64,32),src,Rect.new(32,96,64,32),o)
